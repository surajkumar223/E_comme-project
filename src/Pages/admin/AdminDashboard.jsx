   ...
   // console.log(getAllProduct.length);
    ...
    return (
        <Layoutc>
            <div>
                {/* Top */}
                <div className="px-5 mt-5 mb-2 top">
                ...
                <div className="px-5">
                    ...
                    <div className="mb-5 mid">
                        ...
                        <div className="py-5 border border-pink-100 bg-pink-50 rounded-xl">
                            ...
                            {/* text  */}
                            <div className="">
                                <h1 className="text-lg text-center text-pink-500 "><span className="font-bold ">Name :</span> {user?.name}</h1>
                                <h1 className="text-lg text-center text-pink-500 "><span className="font-bold ">Email :</span> {user.email}</h1>
                                {/* Date  */}
