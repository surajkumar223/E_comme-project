                ...
                {category.map((item, index) => {
                    return (
                        <div key={index} className="px-3 lg:px-10">
                            ...
                            <div onClick={() => navigate(`/category/${item.name}`)} className="w-16 h-16 max-w-xs mb-1 transition-all bg-pink-500 rounded-full cursor-pointer lg:w-24 lg:h-24 hover:bg-pink-400" >
